...
public class NovoFornecedor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        LblProduto.setFont(new java.awt.Font("Arial", 0, 36)); // NOI18N
        LblProduto.setForeground(new java.awt.Color(255, 255, 255));
        LblProduto.setText("Produto");

        TxtProduto.setFont(new java.awt.Font("Arial", 0, 36)); // NOI18N

        TxtCNPJ.setFont(new java.awt.Font("Arial", 0, 36)); // NOI18N
